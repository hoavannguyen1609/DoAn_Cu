        ...
        <div class="row no-gutters">
            <div class="l-12 m-12 c-12 content">
                ...
                <div class="l-10 m-12 c-12 pay-list">
                    <form method="post" id="formPay" class="list-product l-10">
                                ...
                                <div class="list-product__items">
                                    ...
                                    <div class="list-product__box">
                                        <div class="list-product__unit-price">
                                            ...
                                            <span class="list-product__unit-price--text">Đơn giá: <span class="text-doctrine">{{str_replace(',','.',number_format($value['price_product'] - ($value['price_product'] * $value['discount_product'] / 100))) .' ₫'}}</span></span>
                                        </div>
                                        <div class="list-product__amount">
                                            ...
                                            <div class="list-product__input">
                                                <input id="input-<?php echo $value['id_product'] ?>" type="text" name="amountProduct" class="text-center" readonly value="{{$amountProduct}}">
                                            </div>
                                            <div class="list-product__btn">
