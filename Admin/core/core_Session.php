    ...
    static function isInvalidSS() {
        ...
        if (!empty($config['session'])) {
            ...
            if(!empty($sessionConfig['session_key'])) {
                ...
                self::showErrors('Thiếu cấu hình Session. Vui lòng kiểm tra file app/config/config_session.php!');
            }
        } else {
            self::showErrors('Thiếu cấu hình session_key. Vui lòng kiểm tra file app/config/config_session.php!');
        }
    }
}